<?php
	...
	if( isset( $_POST["confirm"] ) ) {
		...
		if( $notice_db !== NoticeDBManager::$CONNECT_ERROR ) {
			switch( $notice_db->delete_post_byid( $_GET["id"] ) ) {
				case NoticeDBManager::$DELETE_ERROR:
		...
		echo "<script>location.href = '/?page=notice&section=$section&action=view&id=$_GET[id]'</script>";
	}
