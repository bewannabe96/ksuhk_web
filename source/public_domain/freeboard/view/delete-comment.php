<?php
	...
	if( isset( $_POST["UserID"] ) && isset( $_POST["UserUsername"] ) && isset( $_POST["CmtID"] ) ) {
		...
		if( $freeboard_db !== FreeboardDBManager::$CONNECT_ERROR ) {
			if( $freeboard_db->check_comment_authority( $_GET["postno"], $_POST["CmtID"], $_POST["UserID"] ) == FreeboardDBManager::$VALID_AUTH ) {
				$freeboard_db->delete_comment_byid( $_GET["postno"], $_POST["CmtID"] );
